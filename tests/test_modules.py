...
from src.tool_usage import calculate, get_time, get_weather
...
class TestStructuredOutputs:
    ...
    def test_person_model(self):
        ...
        person = Person(
            name="John Doe", age=30, occupation="Engineer", skills=["Python", "AI"]
        )
...
class TestResearchAssistant:
    ...
    def test_research_query_model(self):
        ...
        query = ResearchQuery(
            topic="AI Safety", depth="deep", focus_areas=["alignment", "robustness"]
        )
